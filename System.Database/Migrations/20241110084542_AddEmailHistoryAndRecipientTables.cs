...
{
    public partial class AddEmailHistoryAndRecipientTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmailRecipients", x => new { x.EmailHistoryID, x.EmployeeID });
                    table.ForeignKey(
                        name: "FK_EmailRecipients_EmailHistories_EmailHistoryID",
                        column: x => x.EmailHistoryID,
                        principalTable: "EmailHistories",
                        principalColumn: "EmailHistoryID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmailRecipients_Employees_EmployeeID",
